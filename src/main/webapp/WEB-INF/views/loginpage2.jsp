...
@media screen and (max-width:768px){
  ...
  <form id="actionForm" action="loginpage" method="post">
      ...
      <form method="post" action="/controller/login2">
        ...
        <div class="wrap">
         <form method="get" action="kakaologin2">
          <a class="kakao" href="https://kauth.kakao.com/oauth/authorize?client_id=3c29e5973236d66995354c01142b54eb&redirect_uri=http://localhost:9090/controller/kakaolog2&response_type=code">

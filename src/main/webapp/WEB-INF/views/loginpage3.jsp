...
@media screen and (max-width:768px){
  ...
  <body>
    <section class="login-form">
      ...
      <form method="post" action="/controller/login3">
        <div class="int-area">
        ...
        <div class="wrap">
         <form method="get" action="kakaologin">
          <a class="kakao" href="https://kauth.kakao.com/oauth/authorize?client_id=3c29e5973236d66995354c01142b54eb&redirect_uri=http://localhost:9090/controller/kakaolog3&response_type=code">
